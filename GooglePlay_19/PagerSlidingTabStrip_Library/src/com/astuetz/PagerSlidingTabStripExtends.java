...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
	...
	private int tabTextColor = 0xFF666666;  //源码的,下面的是添加扩展
    ...
    private int selectedPosition;//当前viewPager选中页面的索引
    /*--------------- add end ---------------*/
